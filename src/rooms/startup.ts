...
export function buildStartupScene(): HTMLCanvasElement {
  ...
  drawText(ctx, 'climate-fintech', 56, 58, [150, 210, 160], 1, P.black, 1);

  // a whiteboard
  r(ctx, 162, 26, 86, 50, P.cream);
  r(ctx, 160, 24, 90, 54, P.woodDark);
  r(ctx, 162, 26, 86, 2, [220, 220, 214]);
  drawText(ctx, 'PMF or bust', 170, 34, [60, 70, 120], 1, P.cream, 1);
  drawText(ctx, 'ship on Fridays', 170, 46, [150, 90, 70], 1, P.cream, 1);
  ctx.strokeStyle = 'rgb(90,150,100)'; ctx.lineWidth = 1;
  ctx.beginPath(); ctx.moveTo(170, 64); ctx.lineTo(184, 58); ctx.lineTo(198, 62); ctx.lineTo(214, 52); ctx.stroke();
