...
const HOTSPOTS: Hotspot[] = [
  ...
  { id: 'newsstand', name: 'the newsstand', x: 196, y: 58, w: 40, h: 46, walkTo: { x: 210, y: 138 }, url: 'https://www.weekinproduct.com', linkLabel: 'Read Week in Product',
    look: 'Writing and teaching. I write Week in Product, a weekly newsletter for product people, and I teach product management at Product School and EADA.' },
